...
class Question_Answer:
    ...
    def __init__(self, problems, correct_answers):
        self.problems = problems    # hint => 변수에 self를 붙임
        self.correct_answers = correct_answers     # hint => 값에 있던 self를 삭제
    ...
    def problems_main(self):
        ...
        for question in range(4):    # hint => range()안에 4를 넣어줘서 길이값만큼 돌린다고 추가
...
if __name__ == "__main__":
    ...
    question_answer = Question_Answer(list_problems, list_corrects)    # hint => list_correct를 추가
